...
export default function HomeClient() {
  ...
  const dataContents: TableDataProps = {
    ...
    rows: contents.map((content: Content) => [content.headline, content.publicationDate, content.type]),
  };
    ...
    <div>
      ...
      <div className="mt-5 flex flex-col lg:flex-row gap-5">
        ...
        <div className="w-full lg:w-1/2 bg-slate-900 rounded-lg p-4">
          ...
          <Link href={'/dashboard/contenidos'} className="text-slate-400 text-center flex justify-center items-center mt-2 hover:text-cp-primary hover:underline transition">Ver todos</Link>
        </div>
      </div>
        ...
        <div className="w-full lg:w-1/3 bg-slate-900 rounded-lg p-4">
          ...
          {services.length > 0 ? (
            <div className="mt-5">
              ...
              <Link href={'/dashboard/servicios'} className="text-slate-400 text-center flex justify-center items-center mt-2 hover:text-cp-primary hover:underline transition">Ver todos</Link>
            </div>
          ) : (
            <div className="flex justify-center items-center mt-5 h-[100px]">
